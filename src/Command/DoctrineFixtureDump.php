...
use Aquis\XporterPlugin\Service\FixtureDump\EntityReader;
use Aquis\XporterPlugin\Service\FixtureDump\FixturesWriter;
use ReflectionClass;
 ...
 */
class DoctrineFixtureDump extends Command
{
    /**
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($this->alwaysXport as $class) {
            ...
            $entities = $this->entityReader->findAll($class);
